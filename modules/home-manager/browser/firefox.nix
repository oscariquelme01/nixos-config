...
{
  # TODO: configure browserpass and use secure passwords my guy!
  ...
  programs.firefox = {
    ...
    profiles.${username} = {
      ...
      # TODO: at some point build our userChrome.css and userContent.css from https://github.com/ashish-kus/MiniSthetic_Firefox
    };
  };
